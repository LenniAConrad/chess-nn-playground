...
```json
{
  ...
  "idea_registry": [
    ...
    },
    {
      ...
      "notes": "Research-packet promotion from `ideas/research_packets/chess_nn_research_2026-04-24_2115_friday_shanghai_character_sums.md`. Bespoke implementation lives in `src/chess_nn_playground/models/trunk/finite_field_character_sum.py`; the idea-local `model.py` is a thin wrapper around the registered builder.",
    ...
    },
    {
      ...
      "notes": "Bespoke implementation in `src/chess_nn_playground/models/trunk/residual_calibration.py` with idea-local wrapper `ideas/i101_residual_calibration_error_field/model.py`.",
    ...
    },
    {
      ...
      "notes": "Bespoke implementation in `src/chess_nn_playground/models/trunk/set_query_attention.py` with idea-local wrapper `ideas/i102_set_query_attention_bottleneck/model.py`.",
