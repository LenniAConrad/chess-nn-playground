...
FIELDS = [
    ...
    "cpu_inference_samples_per_second", "gpu_inference_samples_per_second",
    "fit_elapsed_seconds",
...
def extract_run(run_dir: Path) -> dict | None:
    ...
    return {
        ...
        "cpu_inference_samples_per_second": _pluck(md, "speed", "cpu_inference_samples_per_second"),
        "gpu_inference_samples_per_second": _pluck(md, "speed", "gpu_inference_samples_per_second"),
