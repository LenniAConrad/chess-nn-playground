...
``ideas/registry/i027_rule_only_counterfactual_move_delta_bottleneck`` (CDBN). The model
...
``ideas/registry/i027_rule_only_counterfactual_move_delta_bottleneck/architecture.md``.
"""
...
from chess_nn_playground.models.trunk.move_landscape_net import (
    PIECE_PLANES,
    PROMO_TYPES,
    RELATIVE_BUCKETS,
    SPECIAL_TYPES,
