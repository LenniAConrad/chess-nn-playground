...
from chess_nn_playground.models.trunk.bitboard_shift_algebra import SHIFT_NAMES, build_shift_maps
from chess_nn_playground.models.trunk.idea_blocks import BoardTensorSpec, ConvNormAct, require_board_tensor
