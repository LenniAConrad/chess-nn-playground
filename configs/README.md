...
The paper-ready trunk pipeline runner generates seeded derived configs under `reports/paper_ready_all/generated_configs/`; keep hand-authored source configs under `configs/`.
