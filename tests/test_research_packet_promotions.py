...
def test_registry_has_no_duplicate_ids_slugs_or_folders():
    rows = _load_jsonl("ideas/registry/registry.jsonl")
...
def test_all_single_research_packets_are_promoted_once_or_known_duplicates():
    packets = _load_jsonl("ideas/research/packets/CATALOG.jsonl")
    registry = _load_jsonl("ideas/registry/registry.jsonl")
