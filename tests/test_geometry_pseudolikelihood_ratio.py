...
from chess_nn_playground.models.trunk.geometry_pseudolikelihood_ratio import StaticChessRelationIndex
...
I036_FOLDER = Path("ideas/registry/i036_geometry_conditioned_board_pseudo_likelihood_ratio_network")
