...
`Counterfactual Move-Delta Spectrum Network` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `move_delta`.
- Active proposal profiles: `move_delta`, `linear_algebra`.
