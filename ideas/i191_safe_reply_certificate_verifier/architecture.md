...
`Safe-Reply Certificate Verifier` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `logic`.
- Active proposal profiles: `logic`, `graph`, `proof_certificate`, `defender_reply`.
