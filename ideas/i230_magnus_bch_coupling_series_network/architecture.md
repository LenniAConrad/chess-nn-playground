...
`Magnus-BCH Operator-Coupling Series Network` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `linear_algebra`.
- Active proposal profile: `magnus_bch_coupling_series_network`.
