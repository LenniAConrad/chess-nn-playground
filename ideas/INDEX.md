...
- Registered implementation states: `{'implemented': 90, 'probe_scaffold_only': 143, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 97, 'shared_probe_variant': 143}`
...
|---|---:|---|
| `bespoke_model` | 97 | Materially distinct model implementation. |
| `shared_probe_variant` | 143 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
