...
- Registered implementation states: `{'implemented': 214, 'probe_scaffold_only': 19, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 221, 'shared_probe_variant': 19}`
...
|---|---:|---|
| `bespoke_model` | 221 | Materially distinct model implementation. |
| `shared_probe_variant` | 19 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
