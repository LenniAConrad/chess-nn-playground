...
- Registered implementation states: `{'implemented': 91, 'probe_scaffold_only': 142, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 98, 'shared_probe_variant': 142}`
...
|---|---:|---|
| `bespoke_model` | 98 | Materially distinct model implementation. |
| `shared_probe_variant` | 142 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
