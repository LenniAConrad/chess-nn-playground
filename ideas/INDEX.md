...
- Registered implementation states: `{'implemented': 121, 'probe_scaffold_only': 112, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 128, 'shared_probe_variant': 112}`
...
|---|---:|---|
| `bespoke_model` | 128 | Materially distinct model implementation. |
| `shared_probe_variant` | 112 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
