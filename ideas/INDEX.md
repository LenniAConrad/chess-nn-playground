...
- Registered implementation states: `{'implemented': 92, 'probe_scaffold_only': 141, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 99, 'shared_probe_variant': 141}`
...
|---|---:|---|
| `bespoke_model` | 99 | Materially distinct model implementation. |
| `shared_probe_variant` | 141 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
