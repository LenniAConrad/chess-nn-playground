...
- Registered implementation states: `{'implemented': 160, 'probe_scaffold_only': 73, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 167, 'shared_probe_variant': 73}`
...
|---|---:|---|
| `bespoke_model` | 167 | Materially distinct model implementation. |
| `shared_probe_variant` | 73 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
