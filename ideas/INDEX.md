...
- Registered implementation states: `{'implemented': 110, 'probe_scaffold_only': 123, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 117, 'shared_probe_variant': 123}`
...
|---|---:|---|
| `bespoke_model` | 117 | Materially distinct model implementation. |
| `shared_probe_variant` | 123 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
