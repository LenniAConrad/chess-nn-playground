...
- Registered implementation states: `{'implemented': 84, 'probe_scaffold_only': 149, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 91, 'shared_probe_variant': 149}`
...
|---|---:|---|
| `bespoke_model` | 91 | Materially distinct model implementation. |
| `shared_probe_variant` | 149 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
