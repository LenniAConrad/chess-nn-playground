...
- Registered implementation states: `{'implemented': 81, 'probe_scaffold_only': 152, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 88, 'shared_probe_variant': 152}`
...
|---|---:|---|
| `bespoke_model` | 88 | Materially distinct model implementation. |
| `shared_probe_variant` | 152 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
