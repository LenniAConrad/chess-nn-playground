...
- Registered implementation states: `{'implemented': 163, 'probe_scaffold_only': 70, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 170, 'shared_probe_variant': 70}`
...
|---|---:|---|
| `bespoke_model` | 170 | Materially distinct model implementation. |
| `shared_probe_variant` | 70 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
