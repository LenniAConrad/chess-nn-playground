...
- Registered implementation states: `{'implemented': 134, 'probe_scaffold_only': 99, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 141, 'shared_probe_variant': 99}`
...
|---|---:|---|
| `bespoke_model` | 141 | Materially distinct model implementation. |
| `shared_probe_variant` | 99 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
