...
- Registered implementation states: `{'implemented': 168, 'probe_scaffold_only': 65, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 175, 'shared_probe_variant': 65}`
...
|---|---:|---|
| `bespoke_model` | 175 | Materially distinct model implementation. |
| `shared_probe_variant` | 65 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
