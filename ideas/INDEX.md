...
- Registered implementation states: `{'implemented': 93, 'probe_scaffold_only': 140, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 100, 'shared_probe_variant': 140}`
...
|---|---:|---|
| `bespoke_model` | 100 | Materially distinct model implementation. |
| `shared_probe_variant` | 140 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
