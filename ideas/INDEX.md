...
- Registered implementation states: `{'implemented': 133, 'probe_scaffold_only': 100, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 140, 'shared_probe_variant': 100}`
...
|---|---:|---|
| `bespoke_model` | 140 | Materially distinct model implementation. |
| `shared_probe_variant` | 100 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
