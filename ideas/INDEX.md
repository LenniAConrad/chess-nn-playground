...
- Registered implementation states: `{'implemented': 143, 'probe_scaffold_only': 90, 'tested': 7}`
- Registered implementation kinds: `{'bespoke_model': 150, 'shared_probe_variant': 90}`
...
|---|---:|---|
| `bespoke_model` | 150 | Materially distinct model implementation. |
| `shared_probe_variant` | 90 | Thin wrapper around `ResearchPacketProbe`; not a separate bespoke architecture. |
