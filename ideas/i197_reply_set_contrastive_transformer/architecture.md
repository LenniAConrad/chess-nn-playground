...
`Reply-Set Contrastive Transformer` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `graph`.
- Active proposal profiles: `graph`, `token_attention`, `defender_reply`.
