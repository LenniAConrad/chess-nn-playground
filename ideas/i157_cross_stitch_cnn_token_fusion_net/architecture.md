...
`Cross-Stitch CNN-Token Fusion Net` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `graph`.
- Active proposal profiles: `graph`, `spatial_cnn`, `token_attention`.
