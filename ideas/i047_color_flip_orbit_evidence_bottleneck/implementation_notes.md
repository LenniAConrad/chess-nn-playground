...
- Idea-local wrapper: `ideas/i047_color_flip_orbit_evidence_bottleneck/model.py`
  delegates to the registered builder.
- Source packet: `ideas/research_packets/chess_nn_research_2026-04-21_0751_tuesday_los_angeles_color_flip_orbit.md`.
