...
- Idea-local wrapper: `ideas/i077_adaptive_tactical_resolvent_network/model.py`.
- Registry key: `adaptive_tactical_resolvent_network` (registered as a bespoke builder, not a `ResearchPacketProbe` variant).
- Source packet: `ideas/research_packets/chess_nn_research_2026-04-25_2002_saturday_shanghai_adaptive_tactical_resolvent.md`.
