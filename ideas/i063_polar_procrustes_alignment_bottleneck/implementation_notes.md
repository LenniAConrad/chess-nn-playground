...
- Idea-local wrapper: `ideas/i063_polar_procrustes_alignment_bottleneck/model.py` (delegates to `build_polar_procrustes_alignment_bottleneck_from_config`).
- Registry key: `polar_procrustes_alignment_bottleneck`.
- Source packet: `ideas/research_packets/chess_nn_research_2026-04-24_2104_friday_shanghai_polar_procrustes.md`.
