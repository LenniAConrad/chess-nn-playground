...
`ideas/research_packets/chess_nn_research_2026-04-25_2004_saturday_shanghai_tactical_controllability_gramian.md`.
...
- Idea-local wrapper: `ideas/i078_tactical_controllability_gramian_network/model.py`.
