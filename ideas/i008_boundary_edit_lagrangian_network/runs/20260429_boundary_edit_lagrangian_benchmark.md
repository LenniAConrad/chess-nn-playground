...
- Used the existing paper-grade idea config at `ideas/i008_boundary_edit_lagrangian_network/config.yaml`.
...
```bash
PYTHONUNBUFFERED=1 python ideas/i008_boundary_edit_lagrangian_network/train.py
