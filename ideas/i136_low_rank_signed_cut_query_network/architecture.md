...
`Low-Rank Signed Cut Query Network` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `linear_algebra`.
- Active proposal profiles: `linear_algebra`, `graph`, `convex`, `token_attention`, `barrier_cut`.
