...
State whether `King-Anchored Euler Interaction Network` is kept, refined, scaled, or rejected. The decision must cite both aggregate metrics and slice behavior.
