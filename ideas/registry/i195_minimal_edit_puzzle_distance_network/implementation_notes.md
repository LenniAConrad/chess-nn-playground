...
- Central code: `src/chess_nn_playground/models/trunk/minimal_edit_puzzle_distance_network.py`.
- Idea-local wrapper: `ideas/registry/i195_minimal_edit_puzzle_distance_network/model.py`.
