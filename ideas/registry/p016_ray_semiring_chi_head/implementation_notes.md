# Implementation Notes — Ray-Semiring χ-Head (p016)

- Central model code: ``src/chess_nn_playground/models/primitives/ray_semiring_chi_head.py``.
- Idea-local wrapper: ``ideas/registry/p016_ray_semiring_chi_head/model.py``.
- Registry key: ``ray_semiring_chi_head``.
- Source primitive packet: ``ideas/research/primitives/external_10_ray_semiring_exchange_and_chi_head.md``.
