# Trainer Notes — Ray-Semiring χ-Head (p016)
...
- ``model.name = ray_semiring_chi_head`` (this idea's wrapper builder)
...
Promotion of p016 requires the falsifier ablations declared in
