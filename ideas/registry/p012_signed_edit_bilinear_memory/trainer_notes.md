# Trainer Notes — Signed-Edit Bilinear Memory (p012)
...
- ``model.name = signed_edit_bilinear_memory`` (this idea's wrapper builder)
...
Promotion of p012 requires the falsifier ablations declared in
