# Implementation Notes — Signed-Edit Bilinear Memory (p012)

- Central model code: ``src/chess_nn_playground/models/primitives/signed_edit_bilinear_memory.py``.
- Idea-local wrapper: ``ideas/registry/p012_signed_edit_bilinear_memory/model.py``.
- Registry key: ``signed_edit_bilinear_memory``.
- Source primitive packet: ``ideas/research/primitives/external_01_signed_edit_bilinear_memory_ray_scan.md``.
