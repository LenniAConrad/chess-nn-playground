# Trainer Notes — Sparse-Delta Accumulator (p013)
...
- ``model.name = sparse_delta_accumulator`` (this idea's wrapper builder)
...
Promotion of p013 requires the falsifier ablations declared in
