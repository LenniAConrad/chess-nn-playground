# Implementation Notes — Sparse-Delta Accumulator (p013)

- Central model code: ``src/chess_nn_playground/models/primitives/sparse_delta_accumulator.py``.
- Idea-local wrapper: ``ideas/registry/p013_sparse_delta_accumulator/model.py``.
- Registry key: ``sparse_delta_accumulator``.
- Source primitive packet: ``ideas/research/primitives/external_07_sparse_delta_accumulator_segment_scatter.md``.
