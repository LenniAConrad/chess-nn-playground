...
- Bespoke implementation: `src/chess_nn_playground/models/trunk/cross_defense_consistency.py`.
- Idea-local wrapper: `ideas/registry/i204_cross_defense_consistency_network/model.py` calls the registered builder.
