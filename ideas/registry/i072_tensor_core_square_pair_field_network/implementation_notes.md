...
- Central code: `src/chess_nn_playground/models/trunk/tensor_core_square_pair_field.py`.
- Registry key: `tensor_core_square_pair_field_network`.
- Idea wrapper: `ideas/registry/i072_tensor_core_square_pair_field_network/model.py`.
