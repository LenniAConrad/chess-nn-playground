...
State whether `Non-Puzzle Score Curl-Divergence Bottleneck` is kept, refined, scaled, or rejected. The decision must cite both aggregate metrics and slice behavior.
