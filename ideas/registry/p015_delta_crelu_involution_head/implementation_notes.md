# Implementation Notes — DeltaCReLU + Involution Reynolds Head (p015)

- Central model code: ``src/chess_nn_playground/models/primitives/delta_crelu_involution.py``.
- Idea-local wrapper: ``ideas/registry/p015_delta_crelu_involution_head/model.py``.
- Registry key: ``delta_crelu_involution_head``.
- Source primitive packet: ``ideas/research/primitives/external_09_delta_crelu_involution_graph_message.md``.
