...
def build_model_from_config(config: dict[str, Any]) -> RankQuantileEvidenceFieldNetwork:
    ...
    return build_rank_quantile_evidence_field_network_from_config(model_cfg)
