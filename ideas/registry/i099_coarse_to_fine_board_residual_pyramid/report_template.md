...
State whether `Coarse-to-Fine Board Residual Pyramid` is kept, refined, scaled, or rejected. The decision must cite both aggregate metrics and slice behavior.
