...
def build_model_from_config(config: dict[str, Any]) -> CoarseToFineBoardResidualPyramid:
    ...
    return build_coarse_to_fine_board_residual_pyramid_from_config(model_cfg)
