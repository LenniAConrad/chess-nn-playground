...
- Bespoke implementation: `src/chess_nn_playground/models/trunk/hierarchical_tactical_option.py`.
- Idea-local wrapper: `ideas/registry/i203_hierarchical_tactical_option_network/model.py` calls the registered builder.
