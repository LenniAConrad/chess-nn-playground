# Implementation Notes — Delta-Event Legal-Move Routing (p017)

- Central model code: ``src/chess_nn_playground/models/primitives/delta_event_legal_routing.py``.
- Idea-local wrapper: ``ideas/registry/p017_delta_event_legal_routing/model.py``.
- Registry key: ``delta_event_legal_routing``.
- Source primitive packet: ``ideas/research/primitives/external_11_delta_event_legal_move_routing.md``.
