# Trainer Notes — Delta-Event Legal-Move Routing (p017)
...
- ``model.name = delta_event_legal_routing`` (this idea's wrapper builder)
...
Promotion of p017 requires the falsifier ablations declared in
