...
def build_model_from_config(config: dict[str, Any]) -> OrientedMatroidCovectorBottleneck:
    ...
    return build_oriented_matroid_covector_bottleneck_from_config(model_cfg)
