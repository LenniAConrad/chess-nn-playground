...
The RSCH mixer is more expensive per call than a 3x3 conv because it
runs a semiring scan over directional rays before applying the chi
head. The shared trainer logs `train_samples_per_second` to
