...
- Central code: `src/chess_nn_playground/models/trunk/tactical_hessian_spectrum_network.py`.
- Idea-local wrapper: `ideas/registry/i199_tactical_hessian_spectrum_network/model.py`.
