...
- Central code: `src/chess_nn_playground/models/trunk/oriented_tactical_sheaf.py` (`OrientedTacticalSheafNet`, `BoardStateAdapter`, `TacticalIncidenceBuilder`, `SquareTokenEncoder`, `SheafDiffusionBlock`, `TriadDefectPool`).
