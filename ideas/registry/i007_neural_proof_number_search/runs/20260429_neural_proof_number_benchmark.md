...
- Used the existing paper-grade idea config at `ideas/registry/i007_neural_proof_number_search/config.yaml`.
...
```bash
PYTHONUNBUFFERED=1 python ideas/registry/i007_neural_proof_number_search/train.py
