# Trainer Notes — Δ-Pair Accumulator (p014)
...
- ``model.name = delta_pair_accumulator`` (this idea's wrapper builder)
...
Promotion of p014 requires the falsifier ablations declared in
