...
def build_model_from_config(config: dict[str, Any]) -> BoundaryConditionDisagreementCNN:
    model_cfg = dict(config.get("model", {}))
    model_cfg.setdefault("num_classes", 1)
    return build_boundary_condition_disagreement_cnn_from_config(model_cfg)
