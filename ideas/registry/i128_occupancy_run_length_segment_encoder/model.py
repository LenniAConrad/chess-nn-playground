...
def build_model_from_config(config: dict[str, Any]) -> OccupancyRunLengthSegmentEncoder:
    model_cfg = dict(config.get("model", {}))
    model_cfg.setdefault("num_classes", 1)
    return build_occupancy_run_length_segment_encoder_from_config(model_cfg)
