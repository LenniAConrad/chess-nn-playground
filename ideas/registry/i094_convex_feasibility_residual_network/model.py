...
def build_model_from_config(config: dict[str, Any]) -> ConvexFeasibilityResidualNetwork:
    ...
    return build_convex_feasibility_residual_network_from_config(model_cfg)
