...
- Central code: `src/chess_nn_playground/models/trunk/cross_stitch_cnn_token_fusion_net.py`.
...
- Reuses `Simple18PieceTokenExtractor` from
  `chess_nn_playground/models/trunk/piece_token_cnn_hybrid.py` to produce up
