...
- Used the existing paper-grade idea config at `ideas/registry/i009_tactical_equilibrium_network/config.yaml`.
...
```bash
PYTHONUNBUFFERED=1 python ideas/registry/i009_tactical_equilibrium_network/train.py
