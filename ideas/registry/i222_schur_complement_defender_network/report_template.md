...
- Packet profile: `schur_complement_defender_network`
...
State whether `Schur-Complement Defender Elimination Network` is kept, refined, scaled, or rejected. The decision
