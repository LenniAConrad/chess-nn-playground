...
- Bespoke source: `src/chess_nn_playground/models/trunk/tropical_constraint_circuit_network.py`.
...
- Source packet: `ideas/research/packets/classic/chess_nn_research_2026-04-24_2046_friday_shanghai_tropical_circuit.md`.
