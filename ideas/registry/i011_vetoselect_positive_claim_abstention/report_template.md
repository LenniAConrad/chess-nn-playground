...
- required slice analysis from `ideas/docs/BENCHMARK_REPORTING.md`, including `slice_report_val.md`, `slice_report_test.md`, `crtk_difficulty`, `crtk_phase`, eval-bucket, motif, and tag-family slice strengths/weaknesses;
