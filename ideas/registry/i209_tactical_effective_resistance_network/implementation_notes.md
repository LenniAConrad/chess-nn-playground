...
- Bespoke implementation: `src/chess_nn_playground/models/trunk/tactical_effective_resistance.py`.
- Idea-local wrapper: `ideas/registry/i209_tactical_effective_resistance_network/model.py` calls the registered builder.
