...
The PRHN mixer is more expensive per call than a 3x3 conv because it
builds a 4-vertex hypercube of perturbed simple_18 tensors per
saliency-selected pair. The shared trainer logs
