# Trainer Notes — DeltaState + SLG Diffusion (p018)
...
- ``model.name = delta_state_slg_diffusion`` (this idea's wrapper builder)
...
Promotion of p018 requires the falsifier ablations declared in
