# Implementation Notes — DeltaState + SLG Diffusion (p018)

- Central model code: ``src/chess_nn_playground/models/primitives/delta_state_slg_diffusion.py``.
- Idea-local wrapper: ``ideas/registry/p018_delta_state_slg_diffusion/model.py``.
- Registry key: ``delta_state_slg_diffusion``.
- Source primitive packet: ``ideas/research/primitives/external_17_delta_state_slg_diffusion_fg_tp.md``.
