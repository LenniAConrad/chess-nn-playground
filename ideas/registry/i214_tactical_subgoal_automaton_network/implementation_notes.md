...
- Bespoke implementation: `src/chess_nn_playground/models/trunk/tactical_subgoal_automaton.py`.
- Idea-local wrapper: `ideas/registry/i214_tactical_subgoal_automaton_network/model.py` calls the registered builder.
