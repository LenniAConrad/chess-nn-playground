...
| `ideas/chatgpt_pro_deep_math_research_prompt.md` | Update | Preserve hard constraints and add anti-duplicate guidance for Hall-deficiency/transversal-matroid overload operators if this packet is consumed. |
...
For `ideas/chatgpt_pro_deep_math_research_prompt.md`, Codex should add a compact memory entry after consuming this packet:
