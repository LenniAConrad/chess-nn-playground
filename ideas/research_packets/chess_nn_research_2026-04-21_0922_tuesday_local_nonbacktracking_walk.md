...
| `ideas/chatgpt_pro_deep_math_research_prompt.md` | Update | Preserve hard constraints and add anti-duplicate guidance for Hashimoto/non-backtracking tactical edge-walk operators after this packet is consumed. |
