...
| `ideas/chatgpt_pro_deep_math_research_prompt.md` | Update | Add this packet to imported research memory after implementation; add anti-duplicate notes for class-conditional board pseudo-likelihood/MDL density-ratio models if the experiment fails. |
