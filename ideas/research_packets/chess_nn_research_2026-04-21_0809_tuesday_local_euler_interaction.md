...
| `ideas/chatgpt_pro_deep_math_research_prompt.md` | Update | Add this packet to imported memory after implementation, including success/failure result and anti-duplicate lesson. Preserve all hard leakage and novelty constraints. |
...
For `ideas/chatgpt_pro_deep_math_research_prompt.md`, Codex should add a short imported-memory fingerprint after consuming results:
