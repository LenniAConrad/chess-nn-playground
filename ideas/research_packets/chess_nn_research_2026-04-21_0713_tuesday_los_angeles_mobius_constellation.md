...
| `ideas/chatgpt_pro_deep_math_research_prompt.md` | Update | Add anti-duplicate guidance for polynomial/ANOVA/factorization-machine piece-constellation networks after this packet is consumed. Preserve all hard leakage and label rules. |
