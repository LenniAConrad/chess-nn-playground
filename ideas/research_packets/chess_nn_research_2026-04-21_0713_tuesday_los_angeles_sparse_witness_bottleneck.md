...
| `ideas/chatgpt_pro_deep_math_research_prompt.md` | Update | Preserve hard constraints and add an anti-duplicate note for sparse occupied-piece top-k witness bottlenecks after this packet is consumed. |
