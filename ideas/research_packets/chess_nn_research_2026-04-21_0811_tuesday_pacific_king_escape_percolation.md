...
| `ideas/chatgpt_pro_deep_math_research_prompt.md` | Update | Add this packet to imported memory and add anti-duplicate notes for king escape percolation if it fails. Preserve all hard leakage and falsification rules. |
