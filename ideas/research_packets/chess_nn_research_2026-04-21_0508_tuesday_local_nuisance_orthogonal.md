...
| `ideas/chatgpt_pro_deep_math_research_prompt.md` | Update | Add this packet to imported research memory after implementation; add anti-duplicate rules for deterministic nuisance orthogonalization and batchwise residual projection if it fails. |
