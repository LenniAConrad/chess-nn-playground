...
| `ideas/chatgpt_pro_deep_math_research_prompt.md` | Update | Preserve hard constraints while adding reusable lessons, anti-duplicate rules, clearer output requirements, and failure-mode guidance discovered from this research pass. |

Required prompt-maintenance behavior:

- After consuming this file, Codex must update `ideas/chatgpt_pro_deep_math_research_prompt.md`.
