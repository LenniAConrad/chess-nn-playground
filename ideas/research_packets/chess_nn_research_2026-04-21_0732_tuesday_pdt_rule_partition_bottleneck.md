...
| `ideas/chatgpt_pro_deep_math_research_prompt.md` | Update | Add this packet to imported research memory after implementation; add anti-duplicate guidance for side-canonical rule-partition invariant bottlenecks if it fails. Preserve all hard leakage and anti-duplicate rules. |
...
For `ideas/chatgpt_pro_deep_math_research_prompt.md`, Codex should append a concise memory entry after consuming this packet:
