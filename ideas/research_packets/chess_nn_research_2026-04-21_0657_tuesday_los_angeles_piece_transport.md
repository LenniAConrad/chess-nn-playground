...
| `ideas/chatgpt_pro_deep_math_research_prompt.md` | Update | Add this packet to imported research memory after implementation, including outcome and anti-duplicate guidance. Preserve all hard leakage/label/falsification constraints. |
