...
- Idea-local wrapper: `ideas/i018_oriented_tactical_sheaf_laplacian/model.py` (`build_model_from_config`).
- Registry key: `oriented_tactical_sheaf_laplacian`.
- Source packet: `ideas/research_packets/chess_nn_research_2026-04-21_0254_tuesday_local_oriented_tactical_sheaf.md`.
