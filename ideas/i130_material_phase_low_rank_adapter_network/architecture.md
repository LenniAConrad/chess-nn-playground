...
`Material-Phase Low-Rank Adapter Network` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `linear_algebra`.
- Active proposal profiles: `linear_algebra`, `tempo`, `phase_calibration`.
