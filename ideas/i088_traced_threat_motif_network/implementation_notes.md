...
- Idea-local wrapper: `ideas/i088_traced_threat_motif_network/model.py`.
- Registry key: `traced_threat_motif_network`.
- Source packet: `ideas/research_packets/chess_nn_research_2026-04-28_0857_tuesday_new_york_trace_motif.md`.
