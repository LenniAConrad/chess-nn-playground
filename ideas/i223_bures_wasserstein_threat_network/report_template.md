...
- Packet profile: `bures_wasserstein_threat_network`
...
State whether `Bures-Wasserstein SPD Threat Manifold Network` is kept, refined, scaled, or rejected. The decision
