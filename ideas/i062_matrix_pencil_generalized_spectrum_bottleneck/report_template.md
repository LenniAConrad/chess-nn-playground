...
State whether `Matrix-Pencil Generalized Spectrum Bottleneck` is kept, refined, scaled, or rejected. The decision must cite both aggregate metrics and slice behavior.
