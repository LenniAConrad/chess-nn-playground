...
`Counterplay Insolvency Ledger` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `graph`.
- Active proposal profiles: `graph`, `proof_certificate`, `defender_reply`.
