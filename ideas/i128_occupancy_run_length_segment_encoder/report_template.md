...
State whether `Occupancy Run-Length Segment Encoder` is kept, refined, scaled, or rejected. The decision must cite both aggregate metrics and slice behavior.
