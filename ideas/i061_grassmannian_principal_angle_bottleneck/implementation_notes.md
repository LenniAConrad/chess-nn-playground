...
- Idea-local wrapper: `ideas/i061_grassmannian_principal_angle_bottleneck/model.py`
...
- Source packet: `ideas/research_packets/chess_nn_research_2026-04-24_2058_friday_shanghai_grassmannian_angles.md`.
