...
State whether `Negative-Class Disentangled Puzzle Head` is kept, refined, scaled, or rejected. The decision must cite both aggregate metrics and slice behavior.
