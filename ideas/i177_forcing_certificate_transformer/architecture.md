...
`Forcing-Certificate Transformer` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `graph`.
- Active proposal profiles: `graph`, `token_attention`, `proof_certificate`.
