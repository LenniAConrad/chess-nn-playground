...
- Idea-local wrapper: `ideas/i028_file_mirror_tension_sheaf/model.py` (`build_model_from_config`).
- Registry key: `file_mirror_tension_sheaf`.
- Source packet: `ideas/research_packets/chess_nn_research_2026-04-21_0437_tuesday_los_angeles_mirror_tension_sheaf.md`.
