...
`Masked Codec Interaction-Curvature Network` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `topology`.
- Active proposal profiles: `topology`, `information`, `graph`.
