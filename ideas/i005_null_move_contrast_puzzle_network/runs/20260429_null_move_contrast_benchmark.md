...
- Used the existing paper-grade idea config at `ideas/i005_null_move_contrast_puzzle_network/config.yaml`.
...
```bash
PYTHONUNBUFFERED=1 python ideas/i005_null_move_contrast_puzzle_network/train.py
