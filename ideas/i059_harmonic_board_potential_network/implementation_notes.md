...
- Idea-local wrapper: `ideas/i059_harmonic_board_potential_network/model.py`
...
- Source packet: `ideas/research_packets/chess_nn_research_2026-04-24_2045_friday_shanghai_harmonic_potential.md`.
