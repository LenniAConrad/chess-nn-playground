...
`Counterfactual Defender Dropout Network` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `move_delta`.
- Active proposal profiles: `move_delta`, `graph`, `robustness`, `defender_reply`.
