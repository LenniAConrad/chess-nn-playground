...
- idea collections: `ideas/research/collections/`
...
ideas/research/packets/CATALOG.md
```
...
| Full packet catalog | `ideas/research/packets/CATALOG.md` |
| Machine-readable packet catalog | `ideas/research/packets/CATALOG.jsonl` |
| Deep Research duplicate-memory prompt | `ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` |
...
|---|---|---|
| `packet` | Raw research note in `ideas/research/packets/`. | Catalog it and update prompt duplicate memory if meaningful. |
...
1. Pick one packet from `ideas/research/packets/CATALOG.md`.
2. Check it against `ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` duplicate-memory sections.
...
6. Append one JSON line to `ideas/registry/registry.jsonl`.
...
1. Copy only relevant Markdown research packets into `ideas/research/packets/classic/`, or into a dedicated subfolder when a batch should stay together.
...
4. Update `ideas/research/packets/README.md` with a compact import summary.
5. Update `ideas/research/collections/` when the batch changes the human grouping of the corpus.
6. Update `ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` so future research avoids near-duplicates.
