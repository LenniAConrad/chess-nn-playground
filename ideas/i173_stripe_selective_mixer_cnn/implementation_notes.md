...
- Idea-local wrapper: `ideas/i173_stripe_selective_mixer_cnn/model.py` exposes `build_model_from_config(config)` that calls `build_stripe_selective_mixer_cnn_from_config`.
