...
- Idea-local wrapper:
  `ideas/i034_entropic_chess_geometry_transport_network/model.py`
  (exports `build_model_from_config(config)`).
- Registered model name: `entropic_chess_geometry_transport_network`.
- Source packet: `ideas/research_packets/chess_nn_research_2026-04-21_0703_tuesday_los_angeles_geom_ot.md`.
