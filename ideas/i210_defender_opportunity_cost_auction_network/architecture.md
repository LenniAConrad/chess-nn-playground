...
`Defender Opportunity-Cost Auction Network` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `graph`.
- Active proposal profiles: `graph`, `convex`, `defender_reply`, `auction_cost`.
