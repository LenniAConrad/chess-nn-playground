...
Codex has imported recent ChatGPT Pro research packets into `ideas/research/packets/classic/`. Treat these as already researched families, not fresh ideas:
...
- `ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md`
