...
| Static attack-defense sheaf / Hodge / Laplacian / curvature model | Recent research packets in `ideas/research/packets/classic/` | Explicitly disallowed as a repeated family unless the operator changes substantially; this packet avoids that family. |
