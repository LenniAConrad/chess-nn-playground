...
| `ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Update | Preserve hard constraints and add anti-duplicate guidance for transport-bottleneck families after this packet is consumed. See Section 13. |
