...
| `ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Edit after consuming | Preserve hard constraints and add lessons from this pass: attack-sheaf duplicate rules, required central ablation, and clearer anti-leakage language for deterministic chess-rule features. |
