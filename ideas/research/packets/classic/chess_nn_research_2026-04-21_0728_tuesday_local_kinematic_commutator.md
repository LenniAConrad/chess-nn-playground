...
| `ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Update | Add this idea fingerprint to imported memory after implementation; add anti-duplicate language for non-commutative chess kinematic Lie-bracket operator banks if it fails or succeeds. Preserve all leakage, label, and falsification constraints. |
