...
| `ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Modify after consuming this output | Preserve hard constraints while adding reusable lessons, anti-duplicate rules, clearer output requirements, and failure-mode guidance discovered during implementation and benchmarking. |

Codex must update `ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` after consuming this output. It should preserve leakage rules, label rules, falsification requirements, and anti-duplicate requirements. Suggested additions are in Section 13.
