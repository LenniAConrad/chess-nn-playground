...
| `ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Update | Add this packet to imported research memory after implementation; add anti-duplicate guidance for OT-over-piece-square transport if it fails; preserve all leakage and label rules. |
