...
| `ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Edit after consuming this output | Preserve hard constraints; add reusable lessons, anti-duplicate rules, output clarity, and failure-mode guidance discovered here. |
