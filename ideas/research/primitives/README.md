...
Single flat folder for every primitive-level research report from the 2026-05-12 and 2026-05-13 sessions. File-name prefixes encode the source (`claude_`, `codex_`, `external_`) and the per-source ordinal; full provenance — primitive name, slug, status, prototype, model — lives in [MANIFEST.md](MANIFEST.md).
...
| `external_*.md` | 41 imported reports from ChatGPT Deep Research, Claude, and Google/Gemini |
...
| [MANIFEST.md](MANIFEST.md) | Authoritative provenance table for all 51 primitive research files |
