...
- Used the existing paper-grade idea config at `ideas/i009_tactical_equilibrium_network/config.yaml`.
...
```bash
PYTHONUNBUFFERED=1 python ideas/i009_tactical_equilibrium_network/train.py
