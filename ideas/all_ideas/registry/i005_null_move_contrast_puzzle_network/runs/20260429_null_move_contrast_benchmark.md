...
- Used the existing paper-grade idea config at `ideas/all_ideas/registry/i005_null_move_contrast_puzzle_network/config.yaml`.
...
```bash
PYTHONUNBUFFERED=1 python ideas/all_ideas/registry/i005_null_move_contrast_puzzle_network/train.py
