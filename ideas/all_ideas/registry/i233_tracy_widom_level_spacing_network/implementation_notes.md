...
- Idea-local wrapper: `ideas/all_ideas/registry/i233_tracy_widom_level_spacing_network/model.py`.
- Source packet: `ideas/all_ideas/research/packets/classic/chess_nn_research_2026-05-05_1610_tuesday_local_tracy_widom_level_spacing.md`.
