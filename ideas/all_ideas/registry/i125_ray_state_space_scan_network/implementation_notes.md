...
- Central code: `src/chess_nn_playground/models/ray_state_space_scan.py`.
- Idea-local wrapper: `ideas/all_ideas/registry/i125_ray_state_space_scan_network/model.py`.
