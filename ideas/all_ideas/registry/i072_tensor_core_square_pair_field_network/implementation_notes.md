...
- Idea wrapper: `ideas/all_ideas/registry/i072_tensor_core_square_pair_field_network/model.py`.
- Source packet: `ideas/all_ideas/research/packets/classic/chess_nn_research_2026-04-24_2148_friday_shanghai_tensorcore_pairfield.md`.
