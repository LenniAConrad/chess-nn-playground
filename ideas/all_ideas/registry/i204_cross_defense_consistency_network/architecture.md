...
`Cross-Defense Consistency Network` is a board-only `puzzle_binary` classifier. The implementation
...
- Idea-local wrapper: `ideas/all_ideas/registry/i204_cross_defense_consistency_network/model.py`
