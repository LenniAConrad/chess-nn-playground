...
- Idea-local wrapper: `ideas/all_ideas/registry/i186_legal_reaction_bottleneck_network/model.py` (thin `build_model_from_config` that delegates to `build_legal_reaction_bottleneck_network_from_config`).
