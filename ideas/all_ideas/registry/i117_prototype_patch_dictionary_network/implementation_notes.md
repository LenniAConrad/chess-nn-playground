...
- Idea-local wrapper:
  `ideas/all_ideas/registry/i117_prototype_patch_dictionary_network/model.py` is a thin
  adapter over
  `build_prototype_patch_dictionary_network_from_config`.
- Source packet:
  `ideas/all_ideas/research/packets/classic/chess_nn_research_2026-04-24_2121_friday_shanghai_architecture_batch_4.md`.
