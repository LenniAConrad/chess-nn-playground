...
- Used the existing paper-grade idea config at `ideas/all_ideas/registry/i013_sparse_relation_pursuit_asymmetry/config.yaml`.
...
```bash
PYTHONUNBUFFERED=1 python ideas/all_ideas/registry/i013_sparse_relation_pursuit_asymmetry/train.py
