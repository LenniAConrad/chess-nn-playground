...
`Ray Grammar Edit-Distance Network` is a board-only `puzzle_binary` classifier. The implementation
...
- Idea-local wrapper: `ideas/all_ideas/registry/i217_ray_grammar_edit_distance_network/model.py`
