...
`Non-Puzzle Score Curl-Divergence Bottleneck` is a board-only `puzzle_binary` classifier. The implementation
...
- Idea-local wrapper: `ideas/all_ideas/registry/i216_non_puzzle_score_curl_divergence_bottleneck/model.py`
