...
- Source implementation file: `src/chess_nn_playground/models/oriented_tactical_sheaf.py`
- Idea-local wrapper: `ideas/all_ideas/registry/i018_oriented_tactical_sheaf_laplacian/model.py`
