...
- Packet profile: `free_probability_r_transform_network`
...
State whether `Free-Probability R-Transform Spectrum Network` is kept, refined, scaled, or rejected. The decision
