...
- Idea-local wrapper: `ideas/all_ideas/registry/i057_soft_formal_concept_closure_network/model.py`.
- Registry key: `soft_formal_concept_closure_network` (registered in
  `src/chess_nn_playground/models/registry.py`).
- Source packet: `ideas/all_ideas/research/packets/classic/chess_nn_research_2026-04-21_0922_tuesday_los_angeles_concept_closure.md`.
