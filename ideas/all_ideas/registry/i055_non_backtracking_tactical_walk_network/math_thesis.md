...
Source packet: `ideas/all_ideas/research/packets/classic/chess_nn_research_2026-04-21_0922_tuesday_local_nonbacktracking_walk.md`.
...
`ideas/all_ideas/registry/i055_non_backtracking_tactical_walk_network/architecture.md` for the
