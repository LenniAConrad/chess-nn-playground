...
- Idea-local wrapper: `ideas/all_ideas/registry/i042_legal_automorphism_quotient_network/model.py` (thin
  delegate around `build_legal_automorphism_quotient_network_from_config`).
- Source packet: `ideas/all_ideas/research/packets/classic/chess_nn_research_2026-04-21_0731_tuesday_los_angeles_orbit_quotient.md`.
