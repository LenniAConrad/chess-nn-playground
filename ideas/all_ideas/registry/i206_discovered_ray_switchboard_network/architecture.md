...
`Discovered-Ray Switchboard Network` is a board-only `puzzle_binary` classifier. The implementation
...
- Idea-local wrapper: `ideas/all_ideas/registry/i206_discovered_ray_switchboard_network/model.py`
