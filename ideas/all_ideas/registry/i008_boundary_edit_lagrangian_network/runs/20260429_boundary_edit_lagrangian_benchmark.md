...
- Used the existing paper-grade idea config at `ideas/all_ideas/registry/i008_boundary_edit_lagrangian_network/config.yaml`.
...
```bash
PYTHONUNBUFFERED=1 python ideas/all_ideas/registry/i008_boundary_edit_lagrangian_network/train.py
