...
- Central code: `src/chess_nn_playground/models/cross_scale_attention_residual_network.py`.
- Idea-local wrapper: `ideas/all_ideas/registry/i104_cross_scale_attention_residual_network/model.py`.
- Registry key: `cross_scale_attention_residual_network`.
...
- Batch candidate: `Cross-Scale Attention Residual Network`.
