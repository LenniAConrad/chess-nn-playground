...
- Idea-local wrapper: `ideas/all_ideas/registry/i020_attack_defense_sheaf_energy_network/model.py`.
- Registry key: `attack_defense_sheaf_energy_network`.
- Source packet: `ideas/all_ideas/research/packets/classic/chess_nn_research_2026-04-21_0255_tuesday_local_attack_defense_sheaf.md`.
