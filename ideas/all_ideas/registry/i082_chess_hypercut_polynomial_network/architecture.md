...
thesis from
`ideas/all_ideas/research/packets/classic/chess_nn_research_2026-04-28_0733_tuesday_new_york_hypercut_poly.md`.
...
- Idea-local wrapper: `ideas/all_ideas/registry/i082_chess_hypercut_polynomial_network/model.py`.
