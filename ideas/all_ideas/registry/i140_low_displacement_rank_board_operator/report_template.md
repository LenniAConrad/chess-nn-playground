...
State whether `Low-Displacement-Rank Board Operator` is kept, refined, scaled, or rejected. The decision must cite both aggregate metrics and slice behavior.
