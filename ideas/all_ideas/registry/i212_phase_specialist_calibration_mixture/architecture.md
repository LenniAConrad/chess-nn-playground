...
`Phase-Specialist Calibration Mixture` is a board-only `puzzle_binary` classifier. The implementation
...
- Idea-local wrapper: `ideas/all_ideas/registry/i212_phase_specialist_calibration_mixture/model.py`
