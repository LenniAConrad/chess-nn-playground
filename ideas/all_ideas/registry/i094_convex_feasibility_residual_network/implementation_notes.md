...
- Idea-local wrapper: `ideas/all_ideas/registry/i094_convex_feasibility_residual_network/model.py` calls the bespoke builder; it does not depend on the shared `ResearchPacketProbe` scaffold.
