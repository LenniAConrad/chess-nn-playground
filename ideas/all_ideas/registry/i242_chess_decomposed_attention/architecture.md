...
- Idea-local wrapper: `ideas/all_ideas/registry/i242_chess_decomposed_attention/model.py`.
- Training config: `ideas/all_ideas/registry/i242_chess_decomposed_attention/config.yaml`.
