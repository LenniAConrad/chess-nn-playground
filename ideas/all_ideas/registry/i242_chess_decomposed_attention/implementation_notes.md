...
- Idea wrapper: `ideas/all_ideas/registry/i242_chess_decomposed_attention/model.py`.
- Config: `ideas/all_ideas/registry/i242_chess_decomposed_attention/config.yaml`.
