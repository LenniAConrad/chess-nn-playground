...
- Central code: `src/chess_nn_playground/models/rank_file_memory_grid_net.py`.
- Idea-local wrapper: `ideas/all_ideas/registry/i169_rank_file_memory_grid_net/model.py`.
- Registry key: `rank_file_memory_grid_net`.
...
- Batch candidate: `Rank-File Memory Grid Net`.
