...
`Pinned Mobility Nullspace Network` is a board-only `puzzle_binary` classifier. The implementation
...
- Idea-local wrapper: `ideas/all_ideas/registry/i208_pinned_mobility_nullspace_network/model.py`
