...
- Bespoke implementation: `src/chess_nn_playground/models/pinned_mobility_nullspace.py`.
- Idea-local wrapper: `ideas/all_ideas/registry/i208_pinned_mobility_nullspace_network/model.py` calls the registered builder.
