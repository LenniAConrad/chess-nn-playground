...
- Central code: `src/chess_nn_playground/models/kernel_mean_prototype_network.py`.
- Idea-local wrapper: `ideas/all_ideas/registry/i107_kernel_mean_prototype_network/model.py`.
