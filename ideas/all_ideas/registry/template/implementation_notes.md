...
- Set `idea.yaml implementation_kind` honestly: use `bespoke_model` only for a materially distinct architecture, `shared_probe_variant` for `ResearchPacketProbe`, and `other_shared_scaffold` for baseline/scaffold wrappers.
