...
- Idea wrapper: `ideas/all_ideas/registry/i036_geometry_conditioned_board_pseudo_likelihood_ratio_network/model.py`.
- Source packet: `ideas/all_ideas/research/packets/classic/chess_nn_research_2026-04-21_0713_tuesday_local_geom_plr.md`.
