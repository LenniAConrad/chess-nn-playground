...
- Idea-local wrapper: `ideas/all_ideas/registry/i032_king_anchored_material_null_transport_bottleneck/model.py` (calls the builder).
- Registry key: `king_anchored_material_null_transport_bottleneck`.
- Source packet: `ideas/all_ideas/research/packets/classic/chess_nn_research_2026-04-21_0657_tuesday_local_material_ot_bottleneck.md`.
