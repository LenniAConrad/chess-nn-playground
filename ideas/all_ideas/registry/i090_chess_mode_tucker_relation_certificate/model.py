...
def build_model_from_config(config: dict[str, Any]) -> ChessModeTuckerRelationCertificate:
    ...
    return build_chess_mode_tucker_relation_certificate_from_config(model_cfg)
