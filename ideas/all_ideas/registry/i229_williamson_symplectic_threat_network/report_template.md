...
- Packet profile: `williamson_symplectic_threat_network`
...
State whether `Williamson Symplectic-Eigenvalue Threat Network` is kept, refined, scaled, or rejected. The decision
