...
- Idea-local wrapper: `ideas/all_ideas/registry/i029_entropic_piece_target_transport_bottleneck/model.py` (thin `build_model_from_config(config)` that delegates to the bespoke builder).
...
- Source packet: `ideas/all_ideas/research/packets/classic/chess_nn_research_2026-04-21_0507_tuesday_los_angeles_transport_bottleneck.md`.
