...
- Central code: `src/chess_nn_playground/models/spatial_film_coordinate_net.py`.
- Idea-local wrapper: `ideas/all_ideas/registry/i165_spatial_film_coordinate_net/model.py`.
