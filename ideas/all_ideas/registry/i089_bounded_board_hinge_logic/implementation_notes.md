...
- Idea-local wrapper: `ideas/all_ideas/registry/i089_bounded_board_hinge_logic/model.py`.
- Registry key: `bounded_board_hinge_logic`.
- Source packet: `ideas/all_ideas/research/packets/classic/chess_nn_research_2026-04-28_0859_tuesday_new_york_bounded_hinge.md`.
