...
- Idea-local wrapper: `ideas/all_ideas/registry/i049_tempo_odd_bottleneck_network/model.py` calling `build_tempo_odd_bottleneck_from_config`.
- Registry key: `tempo_odd_bottleneck_network`.
- Source packet: `ideas/all_ideas/research/packets/classic/chess_nn_research_2026-04-21_0755_tuesday_los_angeles_tempo_odd_bottleneck.md`.
