...
`Defender Opportunity-Cost Auction Network` is a board-only `puzzle_binary` classifier. The implementation
...
- Idea-local wrapper: `ideas/all_ideas/registry/i210_defender_opportunity_cost_auction_network/model.py`
