...
- Idea-local wrapper:
  `ideas/all_ideas/registry/i152_iterative_logit_refinement_cnn/model.py` ->
  `build_iterative_logit_refinement_cnn_from_config`.
- Source packet:
  `ideas/all_ideas/research/packets/classic/chess_nn_research_2026-04-24_2210_friday_shanghai_architecture_batch_9.md`
