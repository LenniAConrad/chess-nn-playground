...
`Defender Timing Schedule Network` is a board-only `puzzle_binary` classifier. The implementation
...
- Idea-local wrapper: `ideas/all_ideas/registry/i205_defender_timing_schedule_network/model.py`
