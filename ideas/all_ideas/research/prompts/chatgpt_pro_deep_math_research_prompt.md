...
Codex has imported recent ChatGPT Pro research packets into `ideas/all_ideas/research/packets/classic/`. Treat these as already researched families, not fresh ideas:
...
- `ideas/all_ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md`
...
For `ideas/all_ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md`, Codex must update the prompt after consuming your output. The update should preserve hard constraints while adding any reusable lessons, new anti-duplicate rules, clearer output requirements, or failure-mode guidance discovered from this research pass.
