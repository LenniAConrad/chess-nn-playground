...
| `ideas/all_ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Modify after consuming | Preserve hard constraints; add lessons, anti-duplicate rules, clearer output requirements, and failure-mode guidance from this pass. Codex must update this file after implementation and benchmarking. |
