...
| `ideas/all_ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Update | Preserve hard constraints; add this packet to imported memory after consumption, including anti-duplicate rule for material-null piece-target OT if it fails. |
