...
| `ideas/all_ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Update | Add prompt maintenance notes from Section 13 after consuming this packet; preserve all hard leakage, label, falsification, and anti-duplicate rules. |
