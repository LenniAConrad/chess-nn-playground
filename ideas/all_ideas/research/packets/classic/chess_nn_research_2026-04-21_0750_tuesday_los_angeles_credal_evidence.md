...
| `ideas/all_ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Update | Preserve all hard constraints; add this packet’s fingerprint to imported memory after implementation; add anti-duplicate rules for credal/evidential fine-label-1 uncertainty heads if this fails. |
