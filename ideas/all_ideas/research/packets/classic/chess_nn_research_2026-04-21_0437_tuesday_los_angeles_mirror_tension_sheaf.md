...
| `ideas/all_ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Update | Preserve hard constraints; add anti-duplicate note for this idea, lessons about partial symmetry, and stricter requirement that future ideas include smallest central-claim ablation. |
