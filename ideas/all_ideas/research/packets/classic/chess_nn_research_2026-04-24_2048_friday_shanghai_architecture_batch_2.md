...
If any candidate is implemented, update `ideas/all_ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` and `ideas/all_ideas/research/packets/README.md` with the exact result.
