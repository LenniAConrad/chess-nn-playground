...
| `ideas/all_ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Update | Add this packet's fingerprint to imported research memory after implementation; add anti-duplicate rule for side-to-move odd/even/null-centered turn-intervention bottlenecks if it fails. |
