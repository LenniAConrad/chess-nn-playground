...
| `ideas/all_ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Update | Add this packet to imported memory after implementation, including anti-duplicate notes about class-conditional denoising score-field bottlenecks. Preserve all hard leakage and anti-duplicate constraints. |
