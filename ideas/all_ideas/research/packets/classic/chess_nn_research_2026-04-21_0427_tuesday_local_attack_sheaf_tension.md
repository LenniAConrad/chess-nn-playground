...
| `ideas/all_ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Edit after consuming | Preserve hard constraints and add lessons from this pass: attack-sheaf duplicate rules, required central ablation, and clearer anti-leakage language for deterministic chess-rule features. |

Codex must update `ideas/all_ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` after consuming this output. The update should preserve all hard constraints while adding reusable lessons, anti-duplicate rules, clearer output requirements, or failure-mode guidance discovered during implementation and benchmarking.
