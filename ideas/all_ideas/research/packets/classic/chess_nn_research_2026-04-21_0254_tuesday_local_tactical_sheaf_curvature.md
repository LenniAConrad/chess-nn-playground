...
| `ideas/all_ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Update after consuming this output | Preserve all hard constraints; add reusable lessons, anti-duplicate rules, clearer output requirements, and failure-mode guidance discovered during this research pass. |
