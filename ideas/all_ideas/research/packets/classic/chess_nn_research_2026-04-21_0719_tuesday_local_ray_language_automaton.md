...
| `ideas/all_ideas/research/prompts/chatgpt_pro_deep_math_research_prompt.md` | Update | Add this packet to imported memory after consumption; add anti-duplicate rule for ray-language/WFSA line scanners if it fails or succeeds. Preserve hard constraints. |
