...
This collection groups the pre-primitive architecture research packets. It does not move the packet files, because registered ideas and prompts already cite many stable paths under `ideas/all_ideas/research/packets/classic/`.
...
- Raw packet markdowns: `ideas/all_ideas/research/packets/classic/*.md`
- Generated packet catalog: `ideas/all_ideas/research/packets/CATALOG.md`
- Registered implementations: `ideas/all_ideas/registry/i###_*/`
...
```bash
rg -n "<concept words>" ideas/all_ideas/research/collections ideas/all_ideas/research/packets ideas/all_ideas/registry/i*_*/{math_thesis.md,architecture.md,ablations.md,idea.yaml}
```
