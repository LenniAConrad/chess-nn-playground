...
State whether `Geometry-Conditioned Board Pseudo-Likelihood Ratio Network` is kept, refined, scaled, or rejected. The decision must cite both aggregate metrics and slice behavior.
