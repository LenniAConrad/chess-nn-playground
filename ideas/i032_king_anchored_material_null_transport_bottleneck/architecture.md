...
`King-Anchored Material-Null Transport Bottleneck` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `transport`.
- Active proposal profiles: `transport`, `king_path`.
