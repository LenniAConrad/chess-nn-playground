...
`Phase-Specialist Calibration Mixture` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `tempo`.
- Active proposal profiles: `tempo`, `robustness`, `phase_calibration`.
