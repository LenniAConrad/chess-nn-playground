...
State whether `Phase-Specialist Calibration Mixture` is kept, refined, scaled, or rejected. The decision must cite both aggregate metrics and slice behavior.
