...
```json
{
  "idea_folders": [
    ...
    },
    {
      ...
      "novelty_claim": "Promoted from `ideas/research_packets/chess_nn_research_2026-04-21_0713_tuesday_local_geom_plr.md`; uses a generic mechanism profile over board-only features rather than generic CNN-only pooling.",
      "output_heads": "One puzzle logit plus packet-profile diagnostics saved to prediction artifacts.",
    ...
    },
    {
      ...
      "novelty_claim": "Promoted from `ideas/research_packets/chess_nn_research_2026-04-21_0713_tuesday_los_angeles_mobius_constellation.md`; uses a sparse mechanism profile over board-only features rather than generic CNN-only pooling.",
      "output_heads": "One puzzle logit plus packet-profile diagnostics saved to prediction artifacts.",
    ...
    },
    {
      ...
      "novelty_claim": "Promoted from `ideas/research_packets/chess_nn_research_2026-04-21_0713_tuesday_los_angeles_sparse_witness_bottleneck.md`; uses a sparse mechanism profile over board-only features rather than generic CNN-only pooling.",
      "output_heads": "One puzzle logit plus packet-profile diagnostics saved to prediction artifacts.",
    ...
    },
    {
      ...
      "output_heads": "One puzzle logit plus packet-profile diagnostics saved to prediction artifacts.",
      "short_thesis": "Relational Query Algebra Network tests whether a generic board mechanism improves puzzle-binary classification.",
      "status": "scaffolded",
      "target_task": "puzzle_binary classification: fine labels 0 and 1 map to non-puzzle, fine label 2 maps to puzzle."
    },
    {
      ...
      "output_heads": "One puzzle logit plus packet-profile diagnostics saved to prediction artifacts.",
      "short_thesis": "Variational Board Action Network tests whether a generic board mechanism improves puzzle-binary classification.",
      "status": "scaffolded",
      "target_task": "puzzle_binary classification: fine labels 0 and 1 map to non-puzzle, fine label 2 maps to puzzle."
    },
    {
      ...
      "output_heads": "One puzzle logit plus packet-profile diagnostics saved to prediction artifacts.",
      "short_thesis": "Tensor-Core Square-Pair Field Network tests whether a linear_algebra board mechanism improves puzzle-binary classification.",
      "status": "scaffolded",
      "target_task": "puzzle_binary classification: fine labels 0 and 1 map to non-puzzle, fine label 2 maps to puzzle."
    },
    {
      ...
      "output_heads": "One puzzle logit plus packet-profile diagnostics saved to prediction artifacts.",
      "short_thesis": "Tiny Chess MicroNet tests whether a generic board mechanism improves puzzle-binary classification.",
      "status": "scaffolded",
      "target_task": "puzzle_binary classification: fine labels 0 and 1 map to non-puzzle, fine label 2 maps to puzzle."
    },
    {
    ...
    },
    {
      ...
      "novelty_claim": "Promoted from `ideas/research_packets/chess_nn_research_2026-05-05_1620_tuesday_local_toda_isospectral_flow.md`; uses a linear_algebra mechanism profile over board-only features.",
      "output_heads": "One puzzle logit plus packet-profile diagnostics saved to prediction artifacts.",
