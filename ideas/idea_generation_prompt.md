...
```json
{
  "idea_folders": [
    ...
    },
    {
      ...
      "novelty_claim": "Promoted from `ideas/research_packets/chess_nn_research_2026-04-24_2118_friday_shanghai_architecture_batch_3.md`; uses an explicit CountSketch + TensorSketch polynomial-kernel feature map over a board feature vector rather than tuple enumeration, attention, or generic CNN-only pooling.",
    ...
    },
    {
      ...
      "novelty_claim": "Promoted from `ideas/research_packets/chess_nn_research_2026-04-24_2118_friday_shanghai_architecture_batch_3.md`; a board-only puzzle classifier whose head reads only maxout region signatures (winner histograms, region/transition counts, margin statistics) rather than raw activations.",
    ...
    },
    {
      ...
      "novelty_claim": "Promoted from `ideas/research_packets/chess_nn_research_2026-04-24_2124_friday_shanghai_architecture_batch_5.md`; uses a masked log-domain Sinkhorn-Knopp transport layer with learned role-prototype costs and an explicit dustbin role rather than the proposal-conditioned probe scaffold.",
    ...
    },
    {
      ...
      "novelty_claim": "Promoted from `ideas/research_packets/chess_nn_research_2026-04-24_2133_friday_shanghai_architecture_batch_6.md`; bespoke implementation pairs a shared CNN backbone with a stack of LoRA-style low-rank adapters whose updates are generated from a deterministic material/phase summary.",
    ...
    },
    {
      ...
      "novelty_claim": "Promoted from `ideas/research_packets/chess_nn_research_2026-04-24_2136_friday_shanghai_architecture_batch_7.md`; bespoke replicator-dynamics architecture over occupied piece tokens with a learned asymmetric payoff matrix split across role heads.",
    ...
    },
    {
      ...
      "novelty_claim": "Promoted from `ideas/research_packets/chess_nn_research_2026-04-24_2216_friday_shanghai_architecture_batch_11.md`; implements an explicit low-rank bilinear head over learned role summaries instead of the additive channel pooling that ordinary CNN heads use.",
    ...
    },
    {
      ...
      "novelty_claim": "Promoted from `ideas/research_packets/chess_nn_research_2026-04-24_2216_friday_shanghai_architecture_batch_11.md`; implements Chebyshev-shell pooling around king/center/edge/promotion anchors followed by a shared GRU over the radial sequence, instead of generic CNN-only pooling.",
    ...
    },
    {
      ...
      "novelty_claim": "Promoted from `ideas/research_packets/chess_nn_research_2026-04-24_2216_friday_shanghai_architecture_batch_11.md`; implements stacked rank-file memory blocks (per-square write -> 8 rank + 8 file memories with learned per-rank/per-file priors -> read-back) instead of generic CNN-only pooling.",
