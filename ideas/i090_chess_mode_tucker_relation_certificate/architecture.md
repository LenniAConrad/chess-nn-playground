...
`Chess-Mode Tucker Relation Certificate` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `linear_algebra`.
- Active proposal profiles: `linear_algebra`, `graph`, `proof_certificate`.
