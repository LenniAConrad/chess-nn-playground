...
State whether `Chess-Mode Tucker Relation Certificate` is kept, refined, scaled, or rejected. The decision must cite both aggregate metrics and slice behavior.
