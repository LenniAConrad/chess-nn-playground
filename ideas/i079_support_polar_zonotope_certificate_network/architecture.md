...
`Support-Polar Zonotope Certificate Network` uses the shared proposal-conditioned research-packet probe.

- Mechanism family: `convex`.
- Active proposal profiles: `convex`, `proof_certificate`.
